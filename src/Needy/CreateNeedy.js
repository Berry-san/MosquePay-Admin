...
export default function CreateNeedy() {
  ...
  const handleSubmit = (e) => {
      ...
      try{
          const res = axios.post(WEB_BASE + 'create_needy_category',
  ...
  return (
          ...
          <h3 className=' text-center text-green-800'> Create Question Category</h3>
              ...
              <FormGroup>
                  ...
                  <input required type="text" name="name" value={needyName} onChange={(e) => setNeedyName(e.target.value)} className=' w-full mb-3 p-3 rounded-md input-round bg-gray-100 '/>
               </FormGroup>
              </Col>
              <Col md="12">
              <FormGroup>
                  <label className=' mt-3'>Description</label>
                  <textarea required name="description" value={needyDescription} onChange={(e) => setNeedyDescription(e.target.value)} className=' form-control rounded-md  bg-gray-100 '></textarea>
               </FormGroup>
              </Col>
